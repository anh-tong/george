...
if __name__ == "__main__":
    ...
    ibp_hodlr_fn = os.path.join("george", "ibphodlr")
    if (os.path.exists(kern_fn + ".pyx") and os.path.exists(hodlr_fn + ".pyx") and os.path.exists(latent_hodlr_fn + ".pyx") and os.path.exists(ibp_hodlr_fn + ".pyx")
    ...
    latent_hodlr_ext = Extension("george.latenthodlr", sources=[latent_hodlr_fn],
                          libraries=libraries, include_dirs=include_dirs)
    ibp_hodlr_ext = Extension("george.ibphodlr", sources=[ibp_hodlr_fn],
                          libraries=libraries, include_dirs=include_dirs)
    extensions = cythonize([kern_ext, hodlr_ext, latent_hodlr_ext, ibp_hodlr_ext])
